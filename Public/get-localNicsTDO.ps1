#region GET_LOCALNICSTDO ; #*------v FUNCTION get-localNicsTDO v------
...
#endregion GET_LOCALNICSTDO ; #*------^ END FUNCTION get-localNicsTDO  ^------

# SIG # Begin signature block
# MIIELgYJKoZIhvcNAQcCoIIEHzCCBBsCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUFDDODZ5l5D0lyKosM8kYOAUk
# v8GgggI4MIICNDCCAaGgAwIBAgIQWsnStFUuSIVNR8uhNSlE6TAJBgUrDgMCHQUA
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQnv1Rh
# ja30xu411vNnUgU1M3EnVDANBgkqhkiG9w0BAQEFAASBgF5chdm+2mGZNANaJrld
# SVF1tkiBGKVEDMIQoVUCy0SVNl6QopzCjuTAF5yL1jvfNknX5miTE0Gz3sK5+2CW
# d9XGGa0WiC2xEAJ4zbY8/MleJSU28MRrJWdankzTOCp32aHK+6Jv4sKFz6v9qexb
# up/uK6821TUVO5CWMIMuZ30T
