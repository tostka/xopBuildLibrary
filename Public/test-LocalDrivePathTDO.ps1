#region TEST_LOCALDRIVEPATHTDO ; #*------v FUNCTION test-LocalDrivePathTDO v------
...
#endregion TEST_LOCALDRIVEPATHTDO ; #*------^ END FUNCTION test-LocalDrivePathTDO  ^------

# SIG # Begin signature block
# MIIELgYJKoZIhvcNAQcCoIIEHzCCBBsCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUb30kLovUQkLoBuuoNln1EqRt
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTJN1g0
# vVQEe9GdLco7c2cuT4cl4TANBgkqhkiG9w0BAQEFAASBgGil2d0fhPVzofWMVBS0
# RvRLmV+txqA9/n2UM0eNvB4GlZnFp1NECehfhp7V6F5BACYfYXP6ppuAl1mHto9v
# rbySI+LFlwK984VR2rLV7G6TQkFtg9xtz4chiM+6qhDqwlH0XJ/zJwZFrCm3251h
# PO/ZCbDyhxMPlNy86Qv3AgnR
