#region GET_GCFAST ; #*------v FUNCTION get-GCFast v------
function get-GCFast {
        <#
        .SYNOPSIS
...
#endregion GET_GCFAST ; #*------^ END FUNCTION get-GCFast  ^------

# SIG # Begin signature block
# MIIELgYJKoZIhvcNAQcCoIIEHzCCBBsCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUJRDM5bqUW5mCDYGgBnFWOh+x
# w3GgggI4MIICNDCCAaGgAwIBAgIQWsnStFUuSIVNR8uhNSlE6TAJBgUrDgMCHQUA
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRRVsN8
# TsTPqkIailssz+2gT+wjojANBgkqhkiG9w0BAQEFAASBgLINaCLv0WnTZxYC2zj7
# VIP3YBe5w/K9dWaicWIsjnV/edBsvXuOvzufBS4ui5erRU+VBFi7sBjgAg7czQiS
# L5rHYW1yPhFuHbNp6CLDSb8nScDM+5wZ2dCc5q8JB28VgQyovOuXmHNGE4ikpjBR
# B028rTyt2qn0MBOcgpTL1LXg
