#region GET_MYPACKAGETDO ; #*------v FUNCTION Get-MyPackageTDO v------
...
#endregion GET_MYPACKAGETDO ; #*------^ END FUNCTION Get-MyPackageTDO  ^------

# SIG # Begin signature block
# MIIELgYJKoZIhvcNAQcCoIIEHzCCBBsCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUqvfs6WYhBzpJkSx6yt8L5X66
# zdygggI4MIICNDCCAaGgAwIBAgIQWsnStFUuSIVNR8uhNSlE6TAJBgUrDgMCHQUA
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBT5XCxc
# LoSKiai34rdf4T3VGaJ/aDANBgkqhkiG9w0BAQEFAASBgHgniqGQ7jHtwdciKGov
# k1z3ktS2QobdzLzCIDa8F7yPVqoWOAoKLee2+O1PFnnen5XUXazE9h22Urmng8SY
# EwdAWrU4zcwE8JzzZzb5IEznGi7CA3Vs+lG2bepwe013C627rB+ZdE1xFciDBWY4
# sXpmNdc9aYOkn64qMTYggg2J
