#region GET_EX16EXCHANGESERVERTDO ; #*------v FUNCTION Get-ex16ExchangeServerTDO v------
...
#endregion GET_EX16EXCHANGESERVERTDO ; #*------^ END FUNCTION Get-ex16ExchangeServerTDO  ^------

# SIG # Begin signature block
# MIIELgYJKoZIhvcNAQcCoIIEHzCCBBsCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUoDCK2/rAA5AisW04fYraihM6
# NFmgggI4MIICNDCCAaGgAwIBAgIQWsnStFUuSIVNR8uhNSlE6TAJBgUrDgMCHQUA
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTUAMHH
# SRwJRXYa2vYrdd35d9mp+TANBgkqhkiG9w0BAQEFAASBgECD4gii0eG9+fOvKIUM
# NtLwpXoMCF4ZeeTMvqriDPUuETKZBzF7oSajEcJhVxRHEKBBuh3rVezZiFhxLEHC
# 3ajOUn8pPIoYggl3fT4B/Gsp5xyesIw0pq51BvVlqz1TCoxqqwp0oSStVA/9R2pl
# gjSARTlkoUx3MabXVOpKaQjQ
